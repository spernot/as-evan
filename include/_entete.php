<?php
	...
	class ConstantesEntete {
		public static $NOM_MENU = array('index', 'presentation', 'planning',
			'contact', 'articles', 'informations', 'ecouteretvoir', 'liens', 'projet');
		public static $COULEUR_MENU_SELECTION = array("#1AA8EA;", "#FF0000;", "#FEBD0B;", 
			"#1AA8EA;", "#E66125;", "#75487C;", "#7DCB2C;", "#0A6B7C;", "#1AA8EA;");
		public static $COULEUR_POLICE = array("white", "white;", "white;", 
			"white;", "white;", "white;", "white;", "white", "white");
		public static $IMAGE_ENTETE = array("versetAccueil.png", "bandePresentation.png", "bandeAgenda.png", 
			"versetAccueil.png", "bandeArticles.png", "bandeNews.png", "bandeMedia.png", "versetAccueil.png", "versetAccueil.png");
	}
...
?>
	...
	<div class="versetAccueil">
		...
		<div class="menu" >
			...
			<a class=<?php gestionClassMenu(5);?> href="informations.php">Informations</a>
			...
			<?php 
				...
				if ($projetManager->unProjetEstEnCours()) { ?>
					<a class=<?php gestionClassMenu(8);?> href="projet.php"><img src="<?php echo(getAliasURI()."/images/etoile.png")?>">&nbsp;Projet</a>
					<?php 
				}
			?>
